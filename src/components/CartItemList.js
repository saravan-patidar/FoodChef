...
import { addItems, decreaseItems, removeItems } from "../utils/cardSlice";
...
const CartItemList = ({ data }) => {
  ...
  return (
    <div className="flex justify-around items-center p-2 m-auto my-2 md:w-4/6 h-28 shadow-md bg-slate-100 rounded-xl">
